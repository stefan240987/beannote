...
function authView() {
  ...
  const oauthButtons = [
    providers.google ? `<button type="button" data-oauth="google" class="flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-white px-4 text-sm font-semibold text-espresso shadow-sm ring-1 ring-latte">
    ...
    providers.apple ? `<button type="button" data-oauth="apple" class="flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-espresso px-4 text-sm font-semibold text-cream">
  ...
  const oauthBlock = oauthButtons ? `
      <div class="mt-6 space-y-3">${oauthButtons}</div>
